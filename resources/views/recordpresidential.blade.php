...
@section('content')
    <div class="row">
        <div class="col-md-10 mx-auto">
            <div class="card">
                <div class="card-body">
                    <h3>Publish presidential Results from {{$constituency->name}} constituency</h3>
                    ...
                    <form method="post" action="{{route('SaveParliamentryResult')}}">
                        {{csrf_field()}}
                        <input value="President" name="type" type="hidden">
                        <div class="row">
                            <div class="col-3">
                            ...
                            <div class="col-3">
                                <label class="form-control-label">Votes</label>
